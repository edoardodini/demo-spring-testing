...
public class EmployeeWebControllerHtmlUnitTest {
	...
	public void test_HomePageWithEmployees_ShouldShowThemInATable() throws Exception {
		when(employeeService.getAllEmployees())
				.thenReturn(asList(new Employee(1L, "test1", 1000), new Employee(2L, "test2", 2000)));
	...
	public void testEditExistentEmployee() throws Exception {
		when(employeeService.getEmployeeById(1)).thenReturn(new Employee(1L, "original name", 1000));
		...
		verify(employeeService).updateEmployeeById(1L, new Employee(1L, "modified name", 2000));
	}
	...
	public void testEditNewEmployee() throws Exception {
		...
		verify(employeeService).insertNewEmployee(new Employee(null, "new name", 1000));
	}
